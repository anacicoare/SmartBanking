        ...
        <Menu shadow="md" width={200}>
            <Menu.Target>
                <div className='flex gap-2 items-center cursor-pointer'>
                    <strong className='capitalize text-gray-600'>{infor?.firstName + " " + infor?.lastName}</strong>
                    <Avatar color="cyan" radius="xl"><span className='uppercase'>{infor?.firstName.substring(0,1)}</span></Avatar>
                </div>
            </Menu.Target>
