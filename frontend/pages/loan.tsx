...
export default function Loan() {
    ...
    const form = useForm({
        initialValues: { user: '', iban: '', amount: '', details: '' },
    ...
    return (
        <React.Fragment>
            ...
            <div className='absolute left-[18%] top-[7%] mt-7 w-[82%]'>
                <Container className="form-container" style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
                    <Modal opened={opened} onClose={close} title="Împrumuturi" centered>
                        <Card withBorder shadow="xl" p={20} radius="md">
